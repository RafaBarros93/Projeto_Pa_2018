...
module.exports.get = async function(id, req, res){
    let retorno = await escritorio.get(id);
    resposta.montaRetorno(retorno, req, res);
}

module.exports.put = async function(dados, req, res){
    let retorno = await escritorio.put(dados);
    resposta.montaRetorno(retorno, req, res);
}

module.exports.delete = async function(id, req, res){
    let retorno = await escritorio.delete(id);
...
module.exports.post = async function(dados, req, res){
    let retorno = await escritorio.post(dados);
    resposta.montaRetorno(retorno, req, res);
}