...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Tipos Ação</div>
        <div class="panel-body">
                ...
                <table class="table table-striped" id="lista_registros">
                    ...
                    <tbody id="lista_registros_corpo">
                        <?php  
                            ...
                            $ch = curl_init();
                            curl_setopt($ch, CURLOPT_URL, BASE_URL_SERVICO."/tipoAcao");
                            ...
                            for($i=0;$i<count($dados); $i++){
                                echo '<tr id="linha'.$dados[$i]['CodigoTipoAcao'].'">';
                                    echo '<td>'.$dados[$i]['Descricao'].'</td>';
                                    echo '<td>';
                                        echo '<button class="btn btn-primary btn-xs" onclick="editar('.$dados[$i]['CodigoTipoAcao'].')">Editar</button>&nbsp;';
                                        echo '<button class="btn btn-danger btn-xs" onclick="excluir('.$dados[$i]['CodigoTipoAcao'].')">Excluir</button>';
                                    echo '</td>';
                                echo '</tr>';
                            }
                        ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal-titulo">Tipo Ação</h4>
                </div>
...
<script src="js/formularios/tipo_acao.js"></script>
